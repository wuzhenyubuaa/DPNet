...
borrowed from: https://github.com/leaderj1001/BottleneckTransformers/blob/main/model.py
'''
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks,  resolution=(352, 352)):
    ...
    def initialize(self):
        self.load_state_dict(torch.load('/userhome/wuzhenyu/mywork/work5/to_pcl_server/res/resnet50-19c8e357.pth'),
                             strict=False)



def ResNet50(resolution=(352, 352)):
    return ResNet(Bottleneck, [3, 4, 6, 3], resolution=resolution)
